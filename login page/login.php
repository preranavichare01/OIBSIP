...
if (isset($_POST['logSub'])) {
    ...
    if ($emailErr == '' && $pwdErr == '') {
        $checkIsUser = json_decode(select_query($con, "*", "user_master", "email='" . $email . "' OR phoneNumber='". $email ."'", "", "", ""));
...
<head>
    ...
    <title>Login | Health Tracking</title>
            ...
            <div class="col-md-8 col-xs-12 login_form">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center pyw-3">
                        <a href="signup.php">Not registerd yet? Signup here</a>
                    </div>
                </div>
            </div>
        </div>
